/****************************************************************************
** Meta object code from reading C++ file 'gplaywidget.h'
**
...
#include "../../yuvrender/gplaywidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'gplaywidget.h' doesn't include <QObject>."
...
const QMetaObject CPlayWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_CPlayWidget.data,
...
void *CPlayWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< CPlayWidget*>(this));
